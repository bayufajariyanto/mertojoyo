    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            ...
            foreach ($member as $m) :
                ...
                if (persen($m['kontrakan'], $m['full_kontrakan']) < 40) {
                    $bg = 'bg-danger';
                } else if (persen($m['kontrakan'], $m['full_kontrakan']) < 60) {
                    $bg = 'bg-warning';
                } else if (persen($m['kontrakan'], $m['full_kontrakan']) < 80) {
                    $bg = '';
                } else if (persen($m['kontrakan'], $m['full_kontrakan']) < 100) {
                    $bg = 'bg-info';
                } else if (persen($m['kontrakan'], $m['full_kontrakan']) >= 100) {
                    $bg = 'bg-success';
                }
